...
class App extends Component {
    ...
    constructor(props) {
        ...
        this.state = {
            vehicles: {},
            isLoading: true,
            vehicleArray: [4, 5, 7, 8, 14, 16, 18, 19, 20, 24, 25, 26, 30,
    ...
    componentDidMount() {
        axios.get(`https://swapi.co/api/vehicles/${this.state.vehicleArray[Math.floor(Math.random() * this.state.vehicleArray.length)]}/`)
            .then(response => this.setState({ vehicles: response.data, isLoading: false }))
            .catch((err) => {
                console.log(err);
            });
    }
                ...
                <View style={{ backgroundColor: '#FFD900' }}>
                    <ScrollView>
                        ...
                        <View style={{ flexDirection: 'row', alignContent: 'space-around' }}>
                            ...
                            <VehicleDetail vehicle={this.state.vehicles} />
                        </View>
                        <View>
                            <AppFooter planet={this.state.vehicles} />
                        </View>
                    </ScrollView>
                </View>
            </View>
